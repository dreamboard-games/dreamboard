...
The launcher reads `manifest.ts`, the reducer ABI in `app/index.ts`, and `ui/App.tsx` from the working directory. It bundles on page load. Refresh the browser after edits.
