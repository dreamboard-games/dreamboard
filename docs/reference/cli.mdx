---
title: "Dreamboard command reference"
description: "Reference for Dreamboard workflows and commands."
---
...
See [Testing](/docs/reference/testing) for the scenario and base-file format.
