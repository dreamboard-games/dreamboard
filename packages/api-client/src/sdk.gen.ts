 ...
 *
 */
export const exchangeAuthToken = <ThrowOnError extends boolean = false>(options: Options<ExchangeAuthTokenData, ThrowOnError>) => (options.client ?? client).post<ExchangeAuthTokenResponses, ExchangeAuthTokenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getAuthJwks = <ThrowOnError extends boolean = false>(options?: Options<GetAuthJwksData, ThrowOnError>) => (options?.client ?? client).get<GetAuthJwksResponses, unknown, ThrowOnError>({ url: '/api/auth/jwks', ...options });
 ...
 */
export const getProjectPlayableRevision = <ThrowOnError extends boolean = false>(options: Options<GetProjectPlayableRevisionData, ThrowOnError>) => (options.client ?? client).get<GetProjectPlayableRevisionResponses, GetProjectPlayableRevisionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/projects/{projectId}/compiled-results/{compiledResultId}/playable',
    ...options
});
 ...
 */
export const getProjectActiveJob = <ThrowOnError extends boolean = false>(options: Options<GetProjectActiveJobData, ThrowOnError>) => (options.client ?? client).get<GetProjectActiveJobResponses, GetProjectActiveJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getProjectUiBundle = <ThrowOnError extends boolean = false>(options: Options<GetProjectUiBundleData, ThrowOnError>) => (options.client ?? client).get<GetProjectUiBundleResponses, GetProjectUiBundleErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getSessionUiBundle = <ThrowOnError extends boolean = false>(options: Options<GetSessionUiBundleData, ThrowOnError>) => (options.client ?? client).get<GetSessionUiBundleResponses, GetSessionUiBundleErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getProjectCommitBuild = <ThrowOnError extends boolean = false>(options: Options<GetProjectCommitBuildData, ThrowOnError>) => (options.client ?? client).get<GetProjectCommitBuildResponses, GetProjectCommitBuildErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/projects/{projectId}/builds/{buildJobId}',
    ...options
});
 ...
 */
export const getProjectCommitBuildSources = <ThrowOnError extends boolean = false>(options: Options<GetProjectCommitBuildSourcesData, ThrowOnError>) => (options.client ?? client).get<GetProjectCommitBuildSourcesResponses, GetProjectCommitBuildSourcesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/projects/{projectId}/builds/{buildJobId}/sources',
    ...options
});
