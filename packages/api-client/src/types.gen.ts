...
export type HexSpiralShape = {
    kind: 'spiral';
    radius: number;
    center?: HexCoordinate;
};

export type HexRingShape = {
    kind: 'ring';
    radius: number;
    center?: HexCoordinate;
};

export type HexRectangleShape = {
    kind: 'rectangle';
    width: number;
    height: number;
    start?: HexCoordinate;
...
export type HexCoordinatesShape = {
    kind: 'coordinates';
    coordinates: Array<HexCoordinate>;
};
...
export type PlayableArtifact = {
    ...
    sha256: string;
    /**
     * Temporary GET URL. Request this revision again if the URL expires.
     */
    url: string;
};
 ...
 */
export type PlayableRevision = {
    compiledResultId: string;
    gameRevisionId: string;
    revisionDigest: string;
    sdkVersion: string;
    manifest: GameTopologyManifest;
    reducer: PlayableArtifact;
    ui: PlayableArtifact;
};
...
export type CreateSessionRequest = {
    ...
    /**
     * Game-owned JSON initialization options, validated by the authored game at initialization.
     */
    options?: {
        [key: string]: unknown;
    };
...
export type ProjectCommitBuildStatus = 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled';

export type ProjectCommitBuild = {
    buildJobId: string;
    commitOid: string;
    treeOid: string;
    status: ProjectCommitBuildStatus;
    /**
     * Present once source files are captured, including failed manifests and builds.
     */
    sourceRevisionId?: string;
    compiledResultId?: string;
    /**
     * Actual revision of the successful compiled result, which can reuse an existing revision.
     */
    gameRevisionId?: string;
    diagnostics: Array<CompilationDiagnostic>;
};

export type ProjectCommitBuildSources = {
    buildJobId: string;
    commitOid: string;
    sourceRevisionId: string;
    sourceTreeHash: string;
    /**
     * Immutable captured source text, available even when no valid game manifest exists.
     */
    files: {
        [key: string]: string;
    };
...
export type GetProjectPlayableRevisionData = {
    body?: never;
    path: {
        /**
         * Portable project lineage identifier
...
export type GetProjectPlayableRevisionErrors = {
    /**
     * Unauthorized - authentication required
     */
    401: ProblemDetails;
...
export type GetProjectPlayableRevisionError = GetProjectPlayableRevisionErrors[keyof GetProjectPlayableRevisionErrors];

export type GetProjectPlayableRevisionResponses = {
    /**
     * Immutable playable code and manifest
     */
    200: PlayableRevision;
};

export type GetProjectPlayableRevisionResponse = GetProjectPlayableRevisionResponses[keyof GetProjectPlayableRevisionResponses];
...
export type GetProjectCommitBuildData = {
    body?: never;
    path: {
        /**
         * Portable project lineage identifier
...
export type GetProjectCommitBuildErrors = {
    /**
     * Unauthorized - authentication required
     */
    401: ProblemDetails;
...
export type GetProjectCommitBuildError = GetProjectCommitBuildErrors[keyof GetProjectCommitBuildErrors];

export type GetProjectCommitBuildResponses = {
    /**
     * Inspect an exact commit build
     */
    200: ProjectCommitBuild;
};

export type GetProjectCommitBuildResponse = GetProjectCommitBuildResponses[keyof GetProjectCommitBuildResponses];

export type GetProjectCommitBuildSourcesData = {
    body?: never;
    path: {
        /**
         * Portable project lineage identifier
...
export type GetProjectCommitBuildSourcesErrors = {
    /**
     * Unauthorized - authentication required
     */
    401: ProblemDetails;
...
export type GetProjectCommitBuildSourcesError = GetProjectCommitBuildSourcesErrors[keyof GetProjectCommitBuildSourcesErrors];

export type GetProjectCommitBuildSourcesResponses = {
    /**
     * Read source files from an exact commit build
     */
    200: ProjectCommitBuildSources;
};

export type GetProjectCommitBuildSourcesResponse = GetProjectCommitBuildSourcesResponses[keyof GetProjectCommitBuildSourcesResponses];
