...
export const zProblemType = z.enum([
    ...
    'urn:dreamboard:problem:project-deleted',
    'urn:dreamboard:problem:project-id-invalid',
    'urn:dreamboard:problem:project-not-found',
    'urn:dreamboard:problem:project-owner-scope-forbidden',
    'urn:dreamboard:problem:project-slug-conflict',
    'urn:dreamboard:problem:resource-not-found',
    'urn:dreamboard:problem:revision-head-conflict',
...
export const zHexagonShape = z.object({
    kind: z.enum(['hexagon']),
    radius: z.int().gte(0).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }),
    center: z.optional(zHexCoordinate)
});

export const zHexSpiralShape = z.object({
    kind: z.enum(['spiral']),
    radius: z.int().gte(0).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }),
    center: z.optional(zHexCoordinate)
});

export const zHexRingShape = z.object({
    kind: z.enum(['ring']),
    radius: z.int().gte(0).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }),
    center: z.optional(zHexCoordinate)
});

export const zHexRectangleShape = z.object({
    kind: z.enum(['rectangle']),
    width: z.int().gte(1).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }),
    height: z.int().gte(1).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }),
    start: z.optional(zHexCoordinate)
});

export const zHexCoordinatesShape = z.object({
    kind: z.enum(['coordinates']),
    coordinates: z.array(zHexCoordinate)
});

export const zHexShape = z.union([
    z.object({
        kind: z.literal('hexagon')
    }).and(zHexagonShape),
    z.object({
    ...
    }).and(zHexRectangleShape),
    z.object({
        kind: z.literal('coordinates')
    }).and(zHexCoordinatesShape)
]);

/**
 * Visual orientation for authored hex coordinates
 */
export const zHexOrientation = z.enum(['pointy', 'flat']);

/**
 * Metadata overriding a generated hex coordinate
 */
export const zHexSpaceOverride = z.object({
    id: z.optional(z.string()),
    typeId: z.optional(z.string()),
...
export const zHexBoardSpec = z.object({
    ...
    scope: zTopologyScope,
    shape: zHexShape,
    exclude: z.optional(z.array(zHexCoordinate)),
    ...
    fields: z.optional(z.record(z.string(), zJsonValue)),
    spaces: z.optional(z.record(z.string(), zHexSpaceOverride)),
 ...
 */
export const zCreateGameRevisionRequest = z.object({
    baseRevisionDigest: z.optional(z.string().regex(/^sha256:[a-f0-9]{64}$/)),
    scope: z.optional(z.enum(['CANONICAL', 'DEV'])),
    source: zCreateGameRevisionSource,
 ...
 */
export const zGameRevision = z.object({
    revisionDigest: z.string().regex(/^sha256:[a-f0-9]{64}$/),
 ...
 */
export const zProjectRevisionSourcesResponse = z.object({
    revisionDigest: z.string().regex(/^sha256:[a-f0-9]{64}$/),
...
export const zPlayableArtifact = z.object({
    sha256: z.string().regex(/^[a-f0-9]{64}$/),
    url: z.url()
});

/**
 * Immutable reducer and UI download descriptors for a specific successful compilation. URLs are temporary; hosts must verify downloaded bytes against SHA-256 and persist content rather than URLs. Hosts must cache referenced media before declaring a revision available offline.
 */
export const zPlayableRevision = z.object({
    compiledResultId: z.uuid(),
    gameRevisionId: z.uuid(),
    revisionDigest: z.string(),
    sdkVersion: z.string(),
    manifest: zGameTopologyManifest,
    reducer: zPlayableArtifact,
    ui: zPlayableArtifact
});
 ...
 */
export const zCreateDemoSessionRequest = z.object({
    seed: z.optional(z.string().regex(/^(0|-?[1-9][0-9]*)$/))
});

/**
 * Runtime player id bound to one canonical demo seat.
 */
export const zDemoSessionSeatBinding = z.object({
    seat: z.int().gte(0),
 ...
 */
export const zDemoReducerArtifactIdentity = z.object({
    scheme: z.enum(['dreamboard-reducer-artifact@1']),
...
export const zProjectCommitBuildStatus = z.enum([
    'queued',
    'running',
    'succeeded',
    'failed',
...
export const zProjectCommitBuild = z.object({
    buildJobId: z.uuid(),
    commitOid: z.string(),
    treeOid: z.string(),
    status: zProjectCommitBuildStatus,
    sourceRevisionId: z.optional(z.uuid()),
    compiledResultId: z.optional(z.uuid()),
    gameRevisionId: z.optional(z.uuid()),
    diagnostics: z.array(zCompilationDiagnostic)
});

export const zProjectCommitBuildSources = z.object({
    buildJobId: z.uuid(),
    commitOid: z.string(),
    sourceRevisionId: z.uuid(),
 ...
 */
export const zRevisionDigest = z.string().regex(/^sha256:[a-f0-9]{64}$/);
 ...
 * Project found
 */
export const zGetProjectBySlugResponse = zProject;

export const zCreateGameRevisionData = z.object({
    body: zCreateGameRevisionRequest,
    path: z.object({
        projectId: z.uuid()
    }),
    query: z.optional(z.never())
 ...
 */
export const zCreateGameRevisionResponse = zGameRevision;

export const zGetProjectRevisionSourcesData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid(),
        revisionDigest: z.string().regex(/^sha256:[a-f0-9]{64}$/)
 ...
 */
export const zGetProjectRevisionSourcesResponse = zProjectRevisionSourcesResponse;

export const zCreateProjectSourceBlobUploadSessionData = z.object({
 ...
 */
export const zCreateProjectSourceBlobUploadSessionResponse = zSourceBlobUploadSession;

export const zQueueProjectRevisionCompileData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid(),
        revisionDigest: z.string().regex(/^sha256:[a-f0-9]{64}$/)
 ...
 */
export const zQueueProjectRevisionCompileResponse = zQueueCompiledResultJobResponse;

export const zGetLatestProjectCompiledResultData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid()
    }),
 ...
 */
export const zGetLatestProjectCompiledResultResponse = zCompiledResult;

export const zListProjectCompiledResultsData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid()
    }),
 ...
 */
export const zListProjectCompiledResultsResponse = zListCompiledResultsResponse;

export const zGetProjectCompiledResultData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid(),
        compiledResultId: z.uuid()
...
export const zGetProjectPlayableRevisionData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid(),
        compiledResultId: z.uuid()
...
/**
 * Immutable playable code and manifest
 */
export const zGetProjectPlayableRevisionResponse = zPlayableRevision;
 ...
 */
export const zEnsureProjectDevCompileResponse = zEnsureDevCompileResponse;

export const zCreateProjectSessionData = z.object({
 ...
 */
export const zCreateProjectSessionResponse = zCreateSessionResponse;

export const zDownloadProjectSourcesData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid()
    }),
 ...
 */
export const zDownloadProjectSourcesResponse = z.string();

export const zGetProjectSourcesData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid()
    }),
...
export const zGetProjectCommitBuildData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid(),
        buildJobId: z.uuid()
 ...
 */
export const zGetProjectCommitBuildResponse = zProjectCommitBuild;

export const zGetProjectCommitBuildSourcesData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        projectId: z.uuid(),
        buildJobId: z.uuid()
 ...
 */
export const zGetProjectCommitBuildSourcesResponse = zProjectCommitBuildSources;
